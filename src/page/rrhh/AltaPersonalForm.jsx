...
export default function AltaPersonalForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    const requiredFields = ["nombre", "cuil", "sector", "fechaIngreso", "puesto", "codigo"];
    ...
    try {
      ...
      const url = "https://script.google.com/macros/s/AKfycbyKLYg_vvXA4OEDC8juXpmuDBHpd_fRcYfzARsaKHeVQ3punfc7H4ajc1B-LC_SCd6ysA/exec";
